...
int WadWriteTexToPng(wad_record * wr, int y_invert, uint32_t opaque_alpha, uint32_t mipmap_level, const char * dir, const char * name);
...
int WadWriteSkiToObj(wad_dir * wd, wad_record * wr,  uint32_t opaque_alpha, uint32_t level_of_detail, uint32_t mipmap_level, const char * dir);
